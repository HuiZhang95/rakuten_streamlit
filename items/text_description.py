...
def text_description():
	...
	with st.expander('Show the distribution of languages in \'designation\' before translation'):
	...
	with st.expander('show the distribution of languages in \'designation\' after translation'):	
