...
def ensemble_model():
    ...
    with st.expander("click here for details"):
        ...
        st.markdown("<h3>Image Ensemble Model</h3>", unsafe_allow_html = True)
        ...
        st.markdown("<h3>Image and Text Ensemble Model</h3>", unsafe_allow_html = True)
        ...
        st.write("The Classifier head was removed from each image and text NN and the dataloader was "
                 ...
                 "input batches and the feature outputs were concatinated before being sent to a "
        ...
        st.write("<b>Step 1:</b> Extract intermediate features from the deepest layer of the trained models "
                 "prior to the classifier head. 2815 features for images and 2407 features for text. <br>"
    ...
    with st.expander("click here for details"):
        st.write("The previous approaches provided an improvement over single models. However, we wanted "
                 ...
                 "SVC, Random Forests, and K-Neighbors Classifiers because they all represent unique and "
